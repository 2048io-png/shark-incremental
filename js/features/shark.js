const SHARK = {
    ...
    get ELO() {
        ...
        exp = exp.add(researchEffect('f1',0)).add(getPAEffect(5,0)).mul(forgeUpgradeEffect('elo_extruder')).mul(simpleCETEffect(0)).mul(simpleCETEffect(1)).mul(simpleCETEffect(2)).mul(simpleCETEffect(3)).mul(coreReactorEffect(11)).mul(spaceBaseUpgEffect('o6'))
